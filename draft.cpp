...
class Tampilan{
	public :
		void printKalkulator(){
			gotoxy(10, 2); cout << "KKKK    KKKK AAAAAAAAAAAA LLLL     KKKK    KKKK UUUU    UUUU LLLL     AAAAAAAAAAAA TTTTTTTTTTTT   OOOOOOOO   RRRRRRRRRR ";
			gotoxy(10, 3); cout << "KKKK    KKKK AAAAAAAAAAAA LLLL     KKKK    KKKK UUUU    UUUU LLLL     AAAAAAAAAAAA TTTTTTTTTTTT  OOOOOOOOOO  RRRR    RRR";
			gotoxy(10, 4); cout << "KKKK   KKKK  AAAA    AAAA LLLL     KKKK   KKKK  UUUU    UUUU LLLL     AAAA    AAAA     TTTT     OOOO    OOOO RRRR    RRR";
			gotoxy(10, 5); cout << "KKKKKKKKK    AAAAAAAAAAAA LLLL     KKKKKKKKK    UUUU    UUUU LLLL     AAAAAAAAAAAA     TTTT     OOOO    OOOO RRRRRRRRR  ";
			gotoxy(10, 6); cout << "KKKK   KKKK  AAAAAAAAAAAA LLLL     KKKK   KKKK  UUUU    UUUU LLLL     AAAAAAAAAAAA     TTTT     OOOO    OOOO RRRR   RRR ";
			gotoxy(10, 7); cout << "KKKK    KKKK AAAA    AAAA LLLLLLLL KKKK    KKKK  UUUUUUUUUU  LLLLLLLL AAAA    AAAA     TTTT      OOOOOOOOOO  RRRR    RRR";
			gotoxy(10, 8); cout << "KKKK    KKKK AAAA    AAAA LLLLLLLL KKKK    KKKK   UUUUUUUU   LLLLLLLL AAAA    AAAA     TTTT       OOOOOOOO   RRRR    RRR";
		}
...
class Welcome{
	...
	public :
		...
		~Welcome(){
            ...
            gotoxy(38, Batas_atas + 4); cout << "\tTerima kasih, " << itr->second << ", semoga harimu menyenangkan." << endl;
            cout << endl;
            getch();
        }
